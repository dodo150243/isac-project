...
zipcode_c int(5) NOT NULL,
 ...
 FOREIGN KEY(address_id) REFERENCES alumni_user(alumni_id)
);
...
phone_number int(10) NOT NULL,
 ...
 FOREIGN KEY(social_id) REFERENCES alumni_user(alumni_id)
);
...
section varchar(250) NOT NULL,
 ...
 FOREIGN KEY(education_id) REFERENCES alumni_user(alumni_id)
);
...
contact int(10) NOT NULL,
 PRIMARY KEY(job_id),
 FOREIGN KEY(job_id) REFERENCES alumni_user(alumni_id)
...
imges varchar(250) NOT NULL,
 PRIMARY KEY(img_id),
  FOREIGN KEY(img_id) REFERENCES alumni_user(alumni_id)
